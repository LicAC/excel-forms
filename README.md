# Formulario Increíble - Paquete de Despliegue de Excel Add-in
Generado con ScriptLab to Add-in Studio (INTEF - Inteligencia Eficiente)

🌐 **URL Pública configurada (GitHub Pages / Hosting):**
- **Sitio Web del Complemento:** [https://licac.github.io/excel-forms/](https://licac.github.io/excel-forms/)
- **Punto de Entrada (Taskpane):** [https://licac.github.io/excel-forms/index.html](https://licac.github.io/excel-forms/index.html)
...
- Enlace público: **https://licac.github.io/excel-forms/**
...
4. Reinicia Excel.
5. Ve a la pestaña **Insertar** ➔ **Mis complementos** ➔ pestaña **Carpeta compartida** y haz clic en **Formulario Increíble**.
