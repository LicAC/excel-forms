# 📊 Formulario increíble con múltiples temas visuales en Excel
...
👉 **[Ver Video en YouTube - HAZ CLIC AQUÍ](https://www.youtube.com/watch?v=OrzfiOWWuYA&sub_confirmation=1)**
...
Puedes ver una simulación interactiva de cómo funciona este complemento sin necesidad de abrir Excel, haciendo clic aquí:
👉 **[Ver Demo Interactiva en Vivo](https://intef-dev.github.io/formulario-excel-increible-scriptlab/demo/)**
...
[![Descargar ZIP](https://img.shields.io/badge/Descargar-Proyecto_ZIP-blue?style=for-the-badge&logo=github)](https://github.com/intef-dev/formulario-excel-increible-scriptlab/archive/refs/heads/main.zip)
...
4. Copia y pega el código de los siguientes archivos en sus respectivas pestañas de Script Lab:
   - **HTML**: Abre [`code.html`](./code.html) e insértalo en la pestaña HTML de Script Lab.
   - **CSS**: Abre [`formulario.dark.css`](./formulario.dark.css) e insértalo en la pestaña CSS de Script Lab.
   - **TypeScript**: Abre [`formulario.ts`](./formulario.ts) e insértalo en la pestaña Script de Script Lab.
5. Haz clic en **Run** en Script Lab y ¡listo!
...
- 🎥 **YouTube:** [Suscríbete a mi Canal de YouTube](https://www.youtube.com/watch?v=OrzfiOWWuYA&sub_confirmation=1)
